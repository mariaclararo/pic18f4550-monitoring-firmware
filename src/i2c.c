...
#define SDA_OFF()   BitClr(PORTA,0)
#define SDA()       BitTst(PORTA,0)
#define SDA_IN()    BitSet(TRISA,0)
#define SDA_OUT()   BitClr(TRISA,0)

#define SCL_OFF()   BitClr(PORTA,1)
#define SCL()       BitTst(PORTA,1)
#define SCL_IN()    BitSet(TRISA,1)
#define SCL_OUT()   BitClr(TRISA,1)
